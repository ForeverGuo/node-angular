...
--
-- Host: localhost
-- Generation Time: Jan 23, 2018 at 05:41 PM
...
INSERT INTO `gl_user` (`id`, `username`, `password`, `email`, `time`) VALUES
(1, 'gys', 'd931c84bdd1d92cb60a64310ea548b8e', '3231935126@qq.com', ''),
(10, 'node', 'd931c84bdd1d92cb60a64310ea548b8e', '123456@qq.com', '1/22/2018, 10:13:42 AM');
...
--
ALTER TABLE `expostor`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '--排序', AUTO_INCREMENT=4;
--
